...
class GuavaLearningTest {
    ...
    void partitionLearningTest1() {
        ...
        // when
        List<List<Integer>> partition = Lists.partition(integers, 1);

        // then
        assertThat(partition).hasSize(6)
                .isEqualTo(List.of(
                        List.of(1),
                        List.of(2),
                        List.of(3),
    ...
    void multimapLearningTest1() {
        ...
        // when
        Collection<String> coffeeMultimap = multimap.get("커피");

        // then
        assertThat(coffeeMultimap).hasSize(3)
                .isEqualTo(List.of(
                        "아메리카노",
                        "카페라떼",
                        "카푸치노"
